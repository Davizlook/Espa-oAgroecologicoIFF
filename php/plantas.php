...
<body>
    ...
    <header class="site-header">
        <a class="brand" href="../index.html#inicio">
            ...
            <span>Raízes <em>da escola</em></span>
        </a>
        <nav class="main-nav">
            <a class="nav-link" href="../index.html#inicio">Início</a>
            <a class="nav-link" href="../index.html#projeto">O projeto</a>
            <a class="nav-link is-active" href="plantas.php">Catálogo <span class="nav-dot"></span></a>
        </nav>
        <a class="header-action" href="../index.html#projeto">Conheça o Projeto &#8599;</a>
    </header>
